...
const Hero = () => {
    ...
    return (
        <div className='relative bg-black text-white text-center py-30' id='home'>
            {showSuccess && (
            ...
            <div className='w-fit mx-auto rounded-full transition-all duration-300 hover:shadow-[0_0_15px_8px_rgba(20,191,255,0.6)]'>
                <img
                    src={MyPhoto}
                    alt="Profile"
                    className='mx-auto mb-6 w-50 h-54 rounded-full object-cover transform transition-transform duration-300 hover:scale-105'
                />
            </div>
            ...
            <p className='mt-4 text-gray-400 px-4 md:px-32'>
            ...
            <div>
                <h2 className='flex justify-start mx-30 mt-20 text-3xl font-bold'>
                    I have knowledge about ,
                </h2>
            </div>
            <div className='text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-blue-600 mx-30 flex justify-start'>
                <Typewriter
